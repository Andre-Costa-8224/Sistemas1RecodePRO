...
namespace AgenciaDeViagens.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID_Cliente,Nome,data_nasc,email,cpf,telefone")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID_Cliente,Nome,data_nasc,email,cpf,telefone")] Cliente cliente)
        {
